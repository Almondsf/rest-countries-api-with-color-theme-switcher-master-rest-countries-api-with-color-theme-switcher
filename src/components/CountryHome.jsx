...
export const CountryHome = ({ themeValue, country}) => {
  
  return (
    <div className='grid grid-cols-4 w-screen my-14 '>
          {country.map((cstuff) =>( <div className={themeValue ? 'h-5/6 flex flex-col w-2/3  drop-shadow-lg bg-darkBlue rounded' : 'h-5/6 flex flex-col w-2/3 drop-shadow-lg bg-lwhite rounded' }>
          ...
          <span>{cstuff.name.official}</span>
