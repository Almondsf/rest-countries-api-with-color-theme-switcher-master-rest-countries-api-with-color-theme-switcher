  ...
  return (
    <div className='md:grid md:grid-cols-4 md:w-screen md:my-14 my-5'>
      {country?.filter((cstuff) => {
        ...
        <div className={themeValue ? 'md:h-5/6 h-2/3 my-6 flex flex-col md:w-2/3 w-1/2  drop-shadow-lg bg-darkBlue rounded' : 'md:h-5/6 h-2/3 flex my-6 flex-col md:w-2/3 w-1/2 drop-shadow-lg bg-lwhite rounded' }>
