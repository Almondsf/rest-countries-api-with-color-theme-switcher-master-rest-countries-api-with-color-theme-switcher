  ...
  return (
    <div className='mx-10 w-screen mt-2 py-2'>
        <div className="flex justify-between drop-shadow rounded">
          ...
          <input className={themeValue ? 'pl-3 border-none outline-none bg-darkBlue' : 'bg-white pl-3 border-none outline-none'} type="search" placeholder="Search for a country"></input></span>
        </div>
